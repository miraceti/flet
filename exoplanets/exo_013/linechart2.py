...
def main(page: ft.Page):
    ...
    data_2 = [
        ft.LineChartData(
            data_points=[
                ft.LineChartDataPoint(0, 1.44),
                ft.LineChartDataPoint(2.6, 2.44),
                ft.LineChartDataPoint(4.9, 1.44),
                ft.LineChartDataPoint(6.8, 5.44),
                ft.LineChartDataPoint(8, 1.44),
                ft.LineChartDataPoint(9.5, 1.44),
                ft.LineChartDataPoint(11, 1.44),
            ],
            stroke_width=5,
